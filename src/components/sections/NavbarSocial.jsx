    ...
    <div className="w-full">
      ...
      <div className={`fixed z-20 w-full transition-colors duration-1000 ${getNavbarClasses()}`}>
        <Navbar>
          <ScrollLink
            to="home"
            className="cursor-pointer w-[50%] phone2:w-[50%] phone3:w-[55%] tablet1:w-[30%] tablet2:w-[30%] desktop1:w-[20%] desktop2:max-w-[190px]"
            spy={true}
            smooth={true}
            duration={500}
            offset={-100}
          ...
          >
            <img
              ...
              className={`bg-transparent ${
                scrolling
                  ? "w-[60%] tablet1:w-[40%] tablet2:w-[50%] desktop1:w-[60%] desktop2:w-[70%]"
                  : "my-[20px] w-full"
